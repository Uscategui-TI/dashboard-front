                  ...
                  body: JSON.stringify({
                    ...
                    htmlContent: `
                      ...
                      <div style="background-color: #f4f4f4; padding: 15px; border-radius: 8px; margin-top: 20px; font-family: 'Arial', sans-serif; color: #333;">
                        <p><strong style="color: #333;">Asunto:</strong> ${form.asunto}</p>
                        <p><strong style="color: #333;">Mensaje:</strong> ${form.mensaje}</p>
                      </div>
...
useEffect(() => {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Listar Solicitudes" homeHref="/solicitud-panel" />
