...
export const EcommerceMetrics1 = ({
  title,
  value,
  toltip,
  text,
      ...
      <div className="flex flex-col justify-between h-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="relative group flex items-center justify-center w-10 h-10 bg-gray-100 rounded-xl dark:bg-gray-800 cursor-pointer">
            ...
            <div
              role="tooltip"
              className="absolute z-10 px-3 py-1.5 text-xs text-gray-800 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 -top-12 left-[0px] -translate-x-[400px] whitespace-nowrap dark:bg-gray-700 dark:text-white dark:border-gray-600"
            >
              {toltip}
              <div className="absolute w-2 h-2 bg-white border-l border-t border-gray-200 rotate-45 -bottom-1 left-[420px] -translate-x-1/2 dark:bg-gray-700 dark:border-gray-600"></div>
            </div>
          </div>
        </div>
