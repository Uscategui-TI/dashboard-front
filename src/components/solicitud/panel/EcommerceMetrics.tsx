...
export const EcommerceMetrics = ({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] w-full flex flex-col justify-between min-h-[360px]">
