...
export const Navbar = () => {
     ...
     // Theme
     const themeToggleDarkIconRef = useRef<HTMLDivElement>(null);
     const themeToggleLightIconRef = useRef<HTMLDivElement>(null);
     ...
     const notificationsIcon = (
      ...
      const userIcon = (
        <p></p>
        // <img className="w-8 h-8 rounded-full" src={currentUser?.image} alt={currentUser?.name}/>
      )
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
                <div className="flex items-center justify-start">
                    ...
                    <NextLink href={ `/` } passHref legacyBehavior >
                        <div className="flex ml-2 md:mr-24">
                            {/* <Image src="/images/logo.png" className="h-8 mr-3" alt="FlowBite Logo" /> */}
                            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Uscategui Admin</span>
                        </div>
                    </NextLink>
                ...
                <div className="flex items-center">
                    ...
                    {/* <!-- Notifications --> */}
                    <Dropdown buttonText="notifications" icon={notificationsIcon}>
                    ...
                    {/* <!-- Apps --> */}
                    <Dropdown buttonText="apps" icon={appsIcon}>
                        <div className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Apps
                        </div>
                    ...
                    {/* <!-- Theme --> */}
                    <button id="theme-toggle" ref={themeToggleBtnRef} type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                        {
                            isDarkMode
                    ...
                    {/* <!-- Profile --> */}
                    <Dropdown buttonText='user-menu' icon={userIcon}>
                        <div className="px-4 py-3" role="none">
                            <p className="text-sm text-gray-900 dark:text-white" role="none">
                            Duvan{/* { currentUser?.name } */}
                            </p>
                            <p className="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                            duriveramo@gmail.com{/* { currentUser?.email } */}
                            </p>
                        </div>
